...
Before you begin, please ensure you have all the parts in the [parts and materials list](https://docs-brown.duckietown.org/books-brown/downloads/opmanual_sky/docs-opmanual_sky/branch/master/opmanual_sky/out/build-parts-and-materials.html).
...
4. Do a [connectivity check](https://docs-brown.duckietown.org/books-brown/downloads/opmanual_sky/docs-opmanual_sky/branch/master/opmanual_sky/out/build-multimeter.html) between each pair of soldered wires (recommend doing this now instead of in checkoff later).  
...
- Do a [connectivity check](https://docs-brown.duckietown.org/books-brown/downloads/opmanual_sky/docs-opmanual_sky/branch/master/opmanual_sky/out/build-multimeter.html) on the XT60 connector cable; verify there is no short between the red and black wire.

- Do a [connectivity check](https://docs-brown.duckietown.org/books-brown/downloads/opmanual_sky/docs-opmanual_sky/branch/master/opmanual_sky/out/opmanual_sky/out/build-multimeter.html) on each ESC; for each ESC, verify there are no shorts between any two wires you soldered.
